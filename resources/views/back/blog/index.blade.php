                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('blog.create') }}" class="btn gradient-purple-bliss shadow-z-1-hover float-right"><i class="ft-plus-square"></i> Add New Record</a>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="inlinebtn">
                                                    ...
                                                    @endisset
                                                    @endif
                                                    <a href="{{ route('blog.edit', $eid) }}" class="btn btn-info btn ml-1"><i class="ft-edit"></i></a>
                                                    @if(Auth::check() && Auth::user()->role_id == 1)
                                                    <form action="{{ route('blog.destroy',$eid) }}" method="post" class="ml-1">
                                                        @csrf
                                                        @method('DELETE')
